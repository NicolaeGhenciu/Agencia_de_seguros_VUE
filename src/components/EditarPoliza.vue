<template>
  <div class="card m-5">
    <div class="card-header"><b>Editar poliza</b></div>
...
export default {
  ...
  methods: {
    //consultamos los datos de la poliza
    polizaUnica() {
      let polizaId = this.$route.query.id;
      fetch("PHP/agencia.php/?consultar_poliza_unica=" + polizaId)
        ...
        await fetch(
          ...
          .then((datosRespuesta) => {
            ...
            this.$router.push({
              ...
              query: { id: this.poliza.id_cliente },
            });
          });
      }
    },
